...
public class MenuOrdenamientoSeleccion {
	OrdenamientoSeleccion metodoSeleccion = new OrdenamientoSeleccion();
	...
	// Menú
	public void menuOrdenamientoSeleccion() {
		System.out.println("\n1) MÉTODO SELECCIÓN");
		...
		case 1:
			...
			case 1:
				System.out.println(
						"\t MÉTODO S-----------------------------------------------------ELECCIÓN CON 1 000 ELEMENTOS");
				System.out.println("Arreglo Original: \n\t" + Arrays.toString(milElementos()));
				metodoSeleccion.ordenamientoSeleccion(milElementos());
				System.out.println("Arreglo Ordenado: \n\t" + Arrays.toString(milElementos()));
				break;

			case 2:
				System.out.println("\t MÉTODO SELECCIÓN CON 10 000 ELEMENTOS");
				System.out.println("Arreglo Original: \n\t" + Arrays.toString(diezMilElementos()));
				metodoSeleccion.ordenamientoSeleccion(diezMilElementos());
				System.out.println("Arreglo Ordenado: \n\t" + Arrays.toString(diezMilElementos()));
				break;

			case 3:
				System.out.println("\t MÉTODO SELECCIÓN CON 100 000 ELEMENTOS");
				System.out.println("Arreglo Original: \n\t" + Arrays.toString(cienMilElementos()));
				metodoSeleccion.ordenamientoSeleccion(cienMilElementos());
				System.out.println("Arreglo Ordenado: \n\t" + Arrays.toString(cienMilElementos()));
				break;

			case 4:
				System.out.println("\t MÉTODO SELECCIÓN CON 1 000 000 ELEMENTOS");
